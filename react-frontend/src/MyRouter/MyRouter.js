...
import AsdadsfPage from "../components/AsdadsfPage/AsdadsfPage";
import SingleAsdadsfPage from "../components/AsdadsfPage/SingleAsdadsfPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/asdadsf" component={AsdadsfPage} exact />
                    <Route path="/asdadsf/:singleAsdadsfId" component={SingleAsdadsfPage} exact />
                    {/* ~cb-add-route~ */}
